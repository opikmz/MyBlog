                        ...
                        <table class="table align-items-center mb-0" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <span class=" font-weight-bold">{{ $s->date }}</span>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <span class=" font-weight-bold">{{ $s->user_id }}</span>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <span class=" font-weight-bold"> <a href="/show_blog/{{ $s->id_post }}">
                                                Lihat</a> | <a href="#" onclick="konfirmasiHapus({{ $s->id_post }})">Hapus </a></span>
                                    </td>
                                </tr>
    ...
    function konfirmasiHapus(id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "{{ url('/destroy_blog') }}"+"/"+ id;
            }
          });
    }
