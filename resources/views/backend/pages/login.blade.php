...
<body class="">
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/act_login">
                    @csrf
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('{{ asset('assets/backend/') }}/img/curved-images/curved6.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="{{ asset('assets/backend/') }}/js/soft-ui-dashboard.min.js?v=1.0.7"></script>
</body>
